...
def upgrade() -> None:
    ...
    op.create_table('phrase_data',
    sa.Column('id', sa.BigInteger(), autoincrement=True, nullable=False, comment='Уникальный идентификатор'),
    sa.Column('phrase_id', sa.BigInteger(), nullable=False, comment='FK на оригинальную фразу'),
    sa.Column('variants', postgresql.JSONB(astext_type=sa.Text()), nullable=False, comment='Варианты по настроению: {"A": {"male": [...5...], "female": [...5...]}, ...}'),
