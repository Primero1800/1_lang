...
PROMPT_T1_VISION_RU = (
    "Посмотри на фото и дай ровно 3 коротких наблюдения о человеке на изображении. "
    ...
    "Никаких пояснений — только JSON-список из 3 строк.\n"
    '["наблюдение 1", "наблюдение 2", "наблюдение 3"]'
)

PROMPT_T1_VISION_EN = (
    "Look at the photo and give exactly 3 short observations about the person in the image. "
    ...
    "No explanations — only a JSON list of 3 strings.\n"
